...
class TrainingJobConfigWidget(ReactiveWidget):
    ...
    def __init__(self, state: "RunState", config_index: int, **kwargs):
        ...
        self.git_check_input = widgets.Checkbox(
            value=self.config.git_check,
    ...
    def _create_layout(self):
        ...
        inputs = widgets.VBox(
            [
                ...
                widgets.HBox([self.spot_input, self.git_check_input]),
        ...
        self.container = widgets.VBox(
            [widgets.HTML(f"<h4>Edit Config {self.config_index}</h4>"), inputs],
    ...
    def _on_save_click(self, button):
        ...
        with self.status_output:
            ...
            tags = [
                tag.strip()
                for tag in self.wandb_tags_input.value.split(",")
                if tag.strip()
            ]
            ...
            updated_config = TrainingJobConfig(
                ...
                git_check=self.git_check_input.value,
    ...
    def render(self):
        """Render the widget (required by ReactiveWidget)."""
