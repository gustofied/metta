...
class ReplayWidget(ReactiveWidget):
    ...
    def _create_layout(self):
        ...
        self.container = widgets.VBox([
            widgets.HTML('<h3>🎬 MettaScope Replays</h3>'),
            controls,
            self.output
            ...
            try:
                ...
                if replays:
                    ...
                    for replay in replays:
                        step_options.append((f"Step {replay['step']} - {replay['label']}", replay['step']))
    ...
    def _load_replay(self):
        ...
        with self.output:
            ...
            if not self.run_selector.value or self.run_selector.value == 'No runs available':
